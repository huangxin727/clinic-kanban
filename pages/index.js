      ...
      <div className="container">
        ...
        <div className="main-grid">
          ...
          <div className="board">
            ...
            {/* 组员视图：接单池 */}
            {!isAdmin && <div className="ticket-section">
              <div className="section-header">
                <span className="title">接单池</span>
                <span className="badge">{filteredTickets.filter(t => !t.member_id).length}</span>
              </div>
              <div style={{ overflowX: 'auto' }}>
                {(() => {
            ...
            {!isAdmin && <div className="ticket-section">
              <div className="section-header">
                <span className="title">工作列表</span>
              ...
              <div style={{ overflowX: 'auto' }}>
                {(() => {
                  ...
                  ) : <div style={{ textAlign: 'center', color: '#9ca3af', padding: '30px 0' }}>暂无工作工单</div>
                })()}
              </div>
            </div>}
